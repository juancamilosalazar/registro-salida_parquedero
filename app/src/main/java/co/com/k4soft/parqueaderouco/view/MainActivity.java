...
import co.com.k4soft.parqueaderouco.view.moviento.MovimientoBaseAdapterActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void gotToVerMovimientos(View view) {
        Intent intent = new Intent(this, MovimientoBaseAdapterActivity.class);
        startActivity(intent);
    }
}
